...
/**
 * Created by vinnun on 11/10/2017.
 */
...
public class ContentPost extends Post {
    ...
    /**
     * Set the routing info from a {@link JSONObject} that must contain the following fields:
     *  <br/> -{@link NewsfeedJSONHelper#ROUTE_NAME}: a String that contain the route name
     *  <br/> -{@link NewsfeedJSONHelper#VARS}: a JSONObject that contain all the vars (in String format) necessary to routing
     * @param routingObject object that contains routing info. If null routing info will be cleared
     * @throws JSONException if the passed param doesn't match the requests
     */
